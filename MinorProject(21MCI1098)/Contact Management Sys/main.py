...
class Contact:
    def __init__(self,root):
        ...
        title=Label(self.root,text="Contacts Book",bd=10,relief=GROOVE,font=("Lemon/Milk",30,"bold"),bg="green" , fg="white")
        title.pack(side=TOP,fill=X)
        lbl_footer = Label(self.root, text="DEV BY MNPREETMNY", font=("Monument Extended", 15, "bold"),
        ...
        m_title=Label(Manage_Frame,text="Manage contacts",bg="mint cream",fg="black",font=("Lemon/Milk",20,"bold"))
        m_title.grid(row=0,columnspan=2,pady=15)

        

        lbl_name=Label(Manage_Frame,text="Name *",bg="mint cream",fg="black",font=("Lemon/Milk",15))
        ...
        lbl_email=Label(Manage_Frame,text="Email *",bg="mint cream",fg="black",font=("Lemon/Milk",15))
        ...
        lbl_gender=Label(Manage_Frame,text="Gender *",bg="mint cream",fg="black",font=("Lemon/Milk",15))
        ...
        lbl_mobileNo=Label(Manage_Frame,text="Mobile No *",bg="mint cream",fg="black",font=("Lemon/Milk",15))
        ...
        lbl_mobileNo=Label(Manage_Frame,text="Tele No",bg="mint cream",fg="black",font=("Lemon/Milk",15))
        ...
        lbl_dob=Label(Manage_Frame,text="D.O.B *",bg="mint cream",fg="black",font=("Lemon/Milk",15))
        ...
        lbl_address=Label(Manage_Frame,text="Address *",bg="mint cream",fg="black",font=("Lemon/Milk",15))
        ...
        lbl_msg=Label(Manage_Frame,text="* means Required fields",bg="mint cream",fg="black",font=("Lemon/Milk",15))
